      ...
      <ul className="flex-1 divide-y divide-slate-100 overflow-y-auto">
        ...
        {filtered.length === 0 && (
          <li className="px-3 py-8 text-center text-sm text-slate-500">
            {/* แยกสองกรณีให้ชัด: ค้นแล้วไม่เจอ กับโหลดรายวิชามาไม่ได้เลย
                ถ้าเขียนรวมกัน ผู้ใช้จะนึกว่าเทอมนี้ไม่เปิดสอนอะไรเลย */}
            {courses.length === 0 ? "ยังโหลดรายวิชาไม่ได้" : "ไม่พบรายวิชาที่ตรงกับคำค้น"}
          </li>
        )}
      </ul>
    </div>
